...
module.exports = class binance extends Exchange {
    ...
    async fetchMarkets (params = {}) {
        ...
        //                     {"filterType":"pct_PRICE","multiplierUp":"5","multiplierDown":"0.2","avgPriceMins":5},
        ...
        //                 "symbol":"BTCUSDT",
        //                 "status":"TRADING",
        //                 "maintMarginpct":"2.5000",
        //                 "requiredMarginpct":"5.0000",
        //                 "baseAsset":"BTC",
        //                 "quoteAsset":"USDT",
        //                 "pricePrecision":2,
        //                 "quantityPrecision":3,
        ...
        //                     {"multiplierDown":"0.8500","multiplierUp":"1.1500","multiplierDecimal":"4","filterType":"pct_PRICE"}
        //                 ],
        ...
        //                     {"limit":200,"filterType":"MAX_NUM_ORDERS"},
        //                     {"multiplierDown":"0.9500","multiplierUp":"1.0500","multiplierDecimal":"4","filterType":"pct_PRICE"}
        //                 ],
    ...
    parseTicker (ticker, market = undefined) {
        ...
        return this.safeTicker ({
            ...
            'pctage': this.safeString (ticker, 'priceChangepct'),
            'average': undefined,
    ...
    parseAccountPosition (position, market = undefined) {
        ...
        let initialMarginpctageString = Precise.stringDiv ('1', leverageString, 8);
        const rational = (1000 % leverage) === 0;
        if (!rational) {
            initialMarginpctageString = Precise.stringDiv (Precise.stringAdd (initialMarginpctageString, '1e-8'), '1', 8);
        }
        ...
        let maintenanceMarginpctageString = undefined;
        for (let i = 0; i < leverageBracket.length; i++) {
            const bracket = leverageBracket[i];
            if (notionalFloatAbs < bracket[0]) {
                break;
            }
            maintenanceMarginpctageString = bracket[1];
        }
        const maintenanceMarginpctage = this.parseNumber (maintenanceMarginpctageString);
        ...
        if (notionalFloat === 0.0) {
            ...
            pctage = this.parseNumber (Precise.stringMul (Precise.stringDiv (unrealizedPnlString, initialMarginString, 4), '100'));
            if (usdm) {
                // calculate liquidation price
                //
                // liquidationPrice = (walletBalance / (contracts * (±1 + mmp))) + (±entryPrice / (±1 + mmp))
                //
                // mmp = maintenanceMarginpctage
                // where ± is negative for long and positive for short
                // TODO: calculate liquidation price for coinm contracts
                let onePlusMaintenanceMarginpctageString = undefined;
                let entryPriceSignString = entryPriceString;
                if (side === 'short') {
                    onePlusMaintenanceMarginpctageString = Precise.stringAdd ('1', maintenanceMarginpctageString);
                } else {
                    onePlusMaintenanceMarginpctageString = Precise.stringAdd ('-1', maintenanceMarginpctageString);
                    entryPriceSignString = Precise.stringMul ('-1', entryPriceSignString);
                }
                const leftSide = Precise.stringDiv (walletBalance, Precise.stringMul (contractsStringAbs, onePlusMaintenanceMarginpctageString));
                const rightSide = Precise.stringDiv (entryPriceSignString, onePlusMaintenanceMarginpctageString);
                ...
                let entryPriceSignString = entryPriceString;
                if (side === 'short') {
                    onePlusMaintenanceMarginpctageString = Precise.stringSub ('1', maintenanceMarginpctageString);
                } else {
                    onePlusMaintenanceMarginpctageString = Precise.stringSub ('-1', maintenanceMarginpctageString);
                    entryPriceSignString = Precise.stringMul ('-1', entryPriceSignString);
                }
                const size = Precise.stringMul (contractsStringAbs, contractSizeString);
                const leftSide = Precise.stringMul (size, onePlusMaintenanceMarginpctageString);
        ...
        return {
            ...
            'initialMarginpctage': this.parseNumber (initialMarginpctageString),
            'maintenanceMargin': maintenanceMargin,
            'maintenanceMarginpctage': maintenanceMarginpctage,
    ...
    parsePositionRisk (position, market = undefined) {
        ...
        if (marginType === 'cross') {
            ...
            if (linear) {
                ...
                const inner = Precise.stringMul (liquidationPriceString, onePlusMaintenanceMarginpctageString);
                ...
                const rightSide = Precise.stringSub (Precise.stringDiv ('1', entryPriceSignString), Precise.stringDiv (onePlusMaintenanceMarginpctageString, liquidationPriceString));
        ...
        const maintenanceMarginpctage = this.parseNumber (maintenanceMarginpctageString);
        const maintenanceMarginString = Precise.stringMul (maintenanceMarginpctageString, notionalStringAbs);
        const maintenanceMargin = this.parseNumber (maintenanceMarginString);
        let initialMarginpctageString = Precise.stringDiv ('1', leverageString, 8);
        const rational = (1000 % leverage) === 0;
        if (!rational) {
            initialMarginpctageString = Precise.stringAdd (initialMarginpctageString, '1e-8');
        }
        const initialMarginString = Precise.stringDiv (Precise.stringMul (notionalStringAbs, initialMarginpctageString), '1', 8);
        const initialMargin = this.parseNumber (initialMarginString);
        let marginRatio = undefined;
        let pctage = undefined;
        ...
        if ((leverageBrackets === undefined) || (reload)) {
            ...
            for (let i = 0; i < response.length; i++) {
                ...
                for (let j = 0; j < brackets.length; j++) {
                    ...
                    const maintenanceMarginpctage = this.safeString (bracket, 'maintMarginRatio');
                    result.push ([ floorValue, maintenanceMarginpctage ]);
                }
