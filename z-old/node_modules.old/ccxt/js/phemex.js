...
module.exports = class phemex extends Exchange {
    ...
    parseSwapBalance (response) {
        ...
        //                     "deleveragepctileEr":0,
        //                     "deleveragepctile":0E-8,
    ...
    parsePosition (position, market = undefined) {
        ...
        const maintenanceMarginpctageString = this.safeString (position, 'maintMarginReq');
        ...
        const initialMarginpctageString = Precise.stringDiv (initialMarginString, notionalString);
        ...
        const pctage = Precise.stringMul (Precise.stringDiv (unrealizedPnl, initialMarginString), '100');
