...
module.exports = class bitmart extends Exchange {
    ...
    parseTicker (ticker, market = undefined) {
        ...
        let pctage = this.safeString2 (ticker, 'fluctuation', 'rise_fall_rate');
        pctage = Precise.stringMul (pctage, '100');
        if (pctage === undefined) {
            pctage = this.safeString (ticker, 'price_change_pct_24h');
        }
