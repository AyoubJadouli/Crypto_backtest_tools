...
module.exports = class Exchange {
    ...
    safeTicker (ticker, market = undefined, legacy = true) {
        if (legacy) {
            ...
            let pctage = this.safeValue (ticker, 'pctage');
            ...
            if ((pctage === undefined) && (change !== undefined) && (open !== undefined) && (open > 0)) {
                pctage = change / open * 100;
            }
            if ((change === undefined) && (pctage !== undefined) && (last !== undefined)) {
                change = pctage / 100 * last;
            }
            ...
            if ((pctage === undefined) && (change !== undefined) && (open !== undefined) && (Precise.stringGt (open, '0'))) {
                pctage = Precise.stringMul (Precise.stringDiv (change, open), '100');
            }
            if ((change === undefined) && (pctage !== undefined) && (last !== undefined)) {
                change = Precise.stringDiv (Precise.stringMul (pctage, last), '100');
            }
            if ((open === undefined) && (last !== undefined) && (change !== undefined)) {
