...
module.exports = class ftx extends Exchange {
    ...
    parseTicker (ticker, market = undefined) {
        ...
        let pctage = this.safeString (ticker, 'change24h');
        if (pctage !== undefined) {
            pctage = Precise.stringMul (pctage, '100');
        }
    ...
    parsePosition (position, market = undefined) {
        ...
        const initialMarginpctage = this.safeString (position, 'initialMarginRequirement');
        const leverage = parseInt (Precise.stringDiv ('1', initialMarginpctage, 0));
        ...
        const initialMargin = Precise.stringMul (notionalString, initialMarginpctage);
        const maintenanceMarginpctageString = this.safeString (position, 'maintenanceMarginRequirement');
        const maintenanceMarginString = Precise.stringMul (notionalString, maintenanceMarginpctageString);
        const unrealizedPnlString = this.safeString (position, 'recentPnl');
        const pctage = this.parseNumber (Precise.stringMul (Precise.stringDiv (unrealizedPnlString, initialMargin, 4), '100'));
        ...
        return {
            ...
            'initialMarginpctage': this.parseNumber (initialMarginpctage),
            'maintenanceMargin': this.parseNumber (maintenanceMarginString),
            'maintenanceMarginpctage': this.parseNumber (maintenanceMarginpctageString),
