...
module.exports = class stex extends Exchange {
    ...
    async fetchMarkets (params = {}) {
        ...
        //                 "buy_fee_pct":"0.20000000",
        //                 "sell_fee_pct":"0.20000000",
        //                 "active":true,
        //                 "delisted":false,
        //                 "pair_message":"",
        ...
        for (let i = 0; i < markets.length; i++) {
            ...
            const buyFee = Precise.stringDiv (this.safeString (market, 'buy_fee_pct'), '100');
            const sellFee = Precise.stringDiv (this.safeString (market, 'sell_fee_pct'), '100');
    ...
    async fetchBalance (params = {}) {
        ...
        //                     { "protocol_name": "OMNI", "protocol_id": 10, "active": true, "withdrawal_fee_currency_id": 272, "withdrawal_fee_const": 10, "withdrawal_fee_pct": 0, "block_explorer_url": "https://omniexplorer.info/search/" },
        //                     { "protocol_name": "ERC20", "protocol_id": 5, "active": true, "withdrawal_fee_const": 1.2, "withdrawal_fee_pct": 0, "block_explorer_url": "https://etherscan.io/tx/" },
        //                     { "protocol_name": "TRON", "protocol_id": 24, "active": true, "withdrawal_fee_currency_id": 272, "withdrawal_fee_const": 0.2, "withdrawal_fee_pct": 0, "block_explorer_url": "https://tronscan.org/#/transaction/" }
        //                 ],
