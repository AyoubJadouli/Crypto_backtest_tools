...
module.exports = class exmo extends Exchange {
    describe () {
        return this.deepExtend (super.describe (), {
            ...
            'fees': {
                ...
                'funding': {
                    'tierBased': false,
                    'pctage': false, // fixed funding fees for crypto, see fetchFundingFees below
                },
            },
            'options': {
                'networks': {
    ...
    parseFixedFloatValue (input) {
        ...
        const ispctage = (input.indexOf ('%') >= 0);
        const parts = input.split (' ');
        const value = parts[0].replace ('%', '');
        const result = parseFloat (value);
        if ((result > 0) && ispctage) {
            throw new ExchangeError (this.id + ' parseFixedFloatValue detected an unsupported non-zero pctage-based fee ' + input);
        }
        return result;
    }
    ...
    async fetchMarkets (params = {}) {
        ...
        //             "min_amount":"1",
        //             "price_precision":8,
        //             "commission_taker_pct":"0.4",
        //             "commission_maker_pct":"0.4"
        //         },
        //     }
        //
        ...
        for (let i = 0; i < keys.length; i++) {
            ...
            const takerString = this.safeString (market, 'commission_taker_pct');
            const makerString = this.safeString (market, 'commission_maker_pct');
            result.push ({
                'id': id,
                'symbol': symbol,
                'base': base,
    ...
    parseTrade (trade, market = undefined) {
        ...
        if (feeCostString !== undefined) {
            ...
            let feeRateString = this.safeString (trade, 'commission_pct');
