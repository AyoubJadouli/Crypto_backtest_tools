...
MAX_FORCAST_SIZE=16
BUY_PCT=1.66
BUY_MODE="IS_CLOSE" #"IS_CLOSE"#IS_HIGH" #IS_MIN"#"BUY_OPTIMAL" #"BUY_FIX" #"BUY_TEST" #"BUY_MIN_CLOSE" # "BUY_TEST" # "BUY_UP_CLOSE" #"BUY_UP" #"BUY_ONLY" #"BUY_DIP" #AFTER_DEPTH #"BUY_UP_CLOSE" #"AFTER_DEPTH_CLOSE"
SELL_PCT=10
AFTER_MARK=1
VERSION=6
TESTING_MOD=False
